      ...
      <div >
        <form onSubmit={SendData2}>
            ...
            <div className="row">
              <div className="">
                ...
                <div className="card-body">
                  <center>
                    <form style={{ backgroundColor: bgColors.cream, width: '700px', height: '350px',padding:"25px", borderRadius:"20px"}}>
                      <center>
                        <table>
          ...
          <center>
            ...
            &nbsp;<button type="submit" className="btn btn-secondary" disabled={budget > 100000}  >Approve</button></center>
